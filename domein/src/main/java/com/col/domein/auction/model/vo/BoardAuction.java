...
public class BoardAuction {
	...
	public BoardAuction(int articleNo, String title, int writerKey, Date writtenDate, Date modifiedDate, Date startDate,
			Date endDate, int readCount, int auctionStatusNo, String content) {
		super();
