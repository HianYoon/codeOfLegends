...
public class PasswordFindEmail {
	
	private Member newMember;
	private HttpServletRequest request;
	private String encodedRandomKey;
	
	public PasswordFindEmail() {
		// TODO Auto-generated constructor stub
	}
	
	public PasswordFindEmail(Member newMember, HttpServletRequest request, String encodedRandomKey) throws Exception {
		super();
	...
	public String emailContent() {
		...
		content="<!DOCTYPE html>\r\n" + 
				...
				+ " 님 비밀번호 변경을 위해 다음 버튼을 클릭해주세요!</h4>\r\n" + 
				"				<br />\r\n" + 
				"				<a\r\n" + 
				"					href='"
				+ request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()
				+ "/member/pwFindEnd.do?memberKey="
