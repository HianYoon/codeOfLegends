...
<section id="context">
	...
	<div class="section-content">
		...
		<form action="${path }/member/myPage/account/business/addBusinessEnd.do" method="post">
				...
				<table>
					...
					<tr>
						<td class="first-column"><input type="text"
							...
							name="businessNickname" placeholder="미입력 시 상호명 자동 입력/ 20자 제한"></td>
					...
					<div class="input-fields">
						<input type="checkbox" value="1" id="beef" name="categories" /> <input
							...
							type="checkbox" value="7" id="electronics" name="categories" />
